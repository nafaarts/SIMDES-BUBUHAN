...
<div class="table-responsive col-lg-auto">
    {{-- <a href="proyek/create" class="btn btn-primary mb-4">Tambah</a> --}}
        ...
        <tbody>
            @foreach ($daftarproyek as $proyek)
                <tr>
                    ...
                    <td>{{ $proyek->judul }}</td>
                    <td>{!! $proyek->excerpt !!}</td>
                    <td>
                        <div class="d-flex" style="gap: 10px">
                        <a href="{{ route('proyek.show', $proyek->id) }}" class="btn btn-info">
                        ...
                        <form action="{{ route('proyek.destroy',  $proyek->id ) }}" method="post" class="d-inline" onsubmit="return confirmDelete(this)">
                            @method('delete')
                            @csrf
